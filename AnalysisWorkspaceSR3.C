...
int AnalysisWorkspaceSR3(){
  ...
  for (unsigned int mass = 0; mass < srmasses.size(); mass++){
    ...
    TH1F* h_signal_in = (TH1F*)f_signal_in->Get("m12_SR3");
    ...
    TH1F* h_cr_in = (TH1F*)f_cr_in->Get("m12_SR3");
    ...
    RooRealVar offsetTF("offsetTF","offset of TF in y direction",0.15,0.01,0.5);
    RooRealVar slopelinTF("slopelinTF","Slope of linear part of TF",-1.27e-5,-1e-4,-1e-6);
