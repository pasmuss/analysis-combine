...
//	Histo with 2HDM results:
	string thdm_production = "public/CMSSW_9_2_15/src/Analysis/MssmHbb/SusHi/FullRun_100PerJob_AllTypesAndBosons";
...
void DrawGraphs(vector<TGraph>& graphs2HDM, const vector<string> &BRs, const double& tanBeta){
	...
	leg.Draw();
	can.Print( (cmsswBase + "/src/Analysis/MssmHbb/macros/pictures/2HDM/Antonio_20191030-1610/" + boson + "_thdm_BRs_sinB_A_mA-" + mA + "_tanB-" + to_string_with_precision(tanBeta,2) + ".pdf").c_str() );
}
