...
if ($#argv<4) then
	...
	sed -i 's/SUBRANGE/SR2/g' bias_datacard.txt
...
combine bias_datacard.txt -M FitDiagnostics -s $seed --setParameters pdf_index=$index_fit,par0=0.000232321,peak=270.117,slope_novoeff=0.0122963,tail=-0.878842,turnon_novoeff=281.955,width=51.8367 --freezeParameters pdf_index --setParameterRanges r=-10,10:tail=-10,-0.5:par0=-0.001,0.001 --toysFile higgsCombineTest.GenerateOnly.mH${mp}.${seed}.root -m $mp -t $ntoys --cminDefaultMinimizerStrategy=0
EOF
