...
int AnalysisWorkspaceSR1(){
  ...
  int normCR = 863362;//FR1
  int normSR = 126510;//FR1
  int rebin = 1;
  ...
  for (unsigned int mass = 0; mass < srmasses.size(); mass++){
    ...
    TFile* f_sr_in = new TFile("/afs/desy.de/user/a/asmusspa/Documents/CMSSW_9_2_15/src/Analysis/Tools/test/Outputdata/TF_bias/Pseudos_evenFiner1GeVBins_1904.root","READ");
    TH1F* SRHist = (TH1F*)f_sr_in->Get("SRHist_SR1");//data_obs SR
